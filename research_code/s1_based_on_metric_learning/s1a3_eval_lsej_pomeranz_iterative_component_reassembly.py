"""
@file: s1a3_eval_lsej_pomeranz_iterative_component_reassembly.py
@description: 使用 S1A E1 + Pomeranz 生成 LSEJ 初始解，再执行我们的迭代式组件重组。
@author: Changxin Ye
@created: 2026-07-28
@version: 1.0
"""
...
def parse_args():
    parser = build_parser()
    parser.description = "以 S1A E1 + Pomeranz CVPR 2011 完整解作为 S1A3 初始布局"
