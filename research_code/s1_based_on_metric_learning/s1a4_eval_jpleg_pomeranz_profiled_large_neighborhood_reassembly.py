"""
@file: s1a4_eval_jpleg_pomeranz_profiled_large_neighborhood_reassembly.py
@description: 在 JPwLEG 上使用 S1A E1 与 Pomeranz CVPR 2011 生成初始布局，
...
def parse_args():
    parser = build_parser()
    parser.description = (
        "在 JPwLEG 上以 S1A E1 + Pomeranz CVPR 2011 完整解作为 S1A4 初始布局"
    )
